...
class poloniex:
    ...
    def api_query(self, command, req={}):
        ...
        if(command == "returnTicker" or command == "return24Volume"):
            ...
            ret = urlopen('https://poloniex.com/public?command=' +
            ...
            ret = urlopen('https://poloniex.com/public?command=returnChartData&currencyPair=' + str(
            ...
            ret = urlopen('https://poloniex.com/tradingApi',
                          post_data, headers)
