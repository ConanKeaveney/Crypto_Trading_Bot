...
class poloniex:
    ...
    def api_query(self, command, req={}):
        ...
        if(command == "returnTicker" or command == "return24Volume"):
            ...
            ret = urlopen('https://poloniex.com/public?command=returnChartData&currencyPair='
                          + str(req['currencyPair']) + '&start=' + str(req['start']) + '&end=' + str(req['end']) + '&period=' + str(req['period']))
            return json.loads(ret.read())
        else:
            req['command'] = command
